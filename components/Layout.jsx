...
const Layout = ({ children }) => {
  return (
    <div className="min-h-screen flex flex-row space-x-0">
        <div className="min-h-screen">
        <div class="w-64 absolute sm:relative bg-gray-800 shadow min-h-screen  flex-col justify-between hidden sm:flex">
                <div class="px-8">
               ...
               <span class="self-center whitespace-nowrap">HW DASHBOARD</span>
                    ...
                    <div class="flex justify-center mt-72 mb-4 w-full">
                        <div class="relative">
