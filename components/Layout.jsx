...
const Layout = ({ children }) => {
  return (
    <div className="min-h-screen w-full flex flex-row space-x-0">
        <div className="min-h-screen">
        <div className="w-64 absolute sm:relative bg-gray-800 shadow min-h-screen  flex-col justify-between hidden sm:flex">
                <div className="px-8">
               ...
               <span className="self-center whitespace-nowrap">HW DASHBOARD</span>
               </Link>
                    </div>
                    <ul className="mt-12">
                        <li className="flex w-full justify-between text-gray-300 cursor-pointer items-center mb-6">
                            <Link href="/project" className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <span className="text-sm ml-2">PNR 1000</span>
                            </Link>
                            
                        </li>
                        <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                        <Link href="/hh" className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <span className="text-sm ml-2">HH2</span>
                            </Link>
                            
                        </li>
                        <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                            <Link href="manpack" className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <span className="text-sm ml-2">MANPACK</span>
                            </Link>
                        </li>
                        <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                            <Link href="vic" className="flex items-center focus:outline-none focus:ring-2 focus:ring-white" >
                                ...
                                <span className="text-sm ml-2">VIC-IP</span>
                            </Link>
                        </li>
                        <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                            <Link href="airborne" className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <span className="text-sm ml-2">AIRBORNE</span>
                            </Link>
                            
                        </li>
                        <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center mb-6">
                            <Link href="/wbn" className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                ...
                                <span className="text-sm ml-2">WBN</span>
                            </Link>
                        </li>
                        <li className="flex w-full justify-between text-gray-400 hover:text-gray-300 cursor-pointer items-center">
                            <Link href="/solan" className="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-settings" width="18" height="18" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" />
                                    <path d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 0 0 2.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 0 0 1.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 0 0 -1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 0 0 -2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 0 0 -2.573 -1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 0 0 -1.065 -2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 0 0 1.066 -2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                                    <circle cx="12" cy="12" r="3" />
                                </svg>
                                <span className="text-sm ml-2">SOLAN</span>
                            </Link>
                        </li>
                    </ul>
                    <div className="flex justify-center mt-72 mb-4 w-full">
                        <div className="relative">
                            ...
                            <input className="bg-gray-700 focus:outline-none focus:ring-1 focus:ring-gray-100 rounded w-full text-sm text-gray-300 placeholder-gray-400  pl-10 py-2" type="text" placeholder="Search" />
                        </div>
                    </div>
                </div>
            ...
            <div className="w-64 z-40 absolute bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden transition duration-150 ease-in-out" id="mobile-nav">
                ...
                <button aria-label="Close sidebar" id="closeSideBar" className=" h-10 w-10 bg-gray-800 absolute right-0 mt-16 -mr-10 flex items-center shadow rounded-tr rounded-br justify-center cursor-pointer text-white" onClick="sidebarHandler(false)">
                ...
                <div className="px-8">
                    ...
                    <div className="flex justify-center mt-48 mb-4 w-full">
                        <div className="relative">
                            ...
                            <input className=" focus:outline-none focus:ring-1 focus:ring-gray-100  rounded w-full text-sm text-gray-300 placeholder-gray-400 bg-gray-100 pl-10 py-2" type="text" placeholder="Search" />
                        </div>
                    </div>
                </div>
                <div className="px-8 border-t border-gray-700">
